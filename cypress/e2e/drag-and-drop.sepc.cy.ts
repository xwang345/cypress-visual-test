describe('Verify drag and drop', () => {
    ...
    it.only('should able to drag and drop element on Material Angular example page', () => {
      ...
      cy.get('#cdk-drop-list-1 .cdk-drag').each(($el) => {
        ...
        cy.wait(400) // In our case, we wait 500ms cause we have animations which we are sure that take this amount of time
