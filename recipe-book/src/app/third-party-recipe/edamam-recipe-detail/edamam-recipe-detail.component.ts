...
export class EdamamRecipeDetailComponent implements OnInit, OnDestroy {
  ...
  columnsToDisplayWithExpandItems = ['image','text', 'quantity', 'measure', 'measure', 'weight', 'foodCategory'];
  ...
  ngOnInit() {
    this.subscription = this.route.params.subscribe(params => {
      ...
      this.selectedEdamamRecipes = this.edamamRecipeService.getEdamamRecipeByLabel(this.recipeLabel);
      ...
      this.selectedEdamamTotalNutrient = this.selectedEdamamRecipes.totalNutrients;
      console.log(`selectedEdamamTotalNutrient: ${JSON.stringify(this.selectedEdamamTotalNutrient)}`);
    });
  }
